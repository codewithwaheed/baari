...
export default function ForgotVerifyPage() {
  ...
  useEffect(() => {
    const stored = sessionStorage.getItem('baari_reset_phone');
    if (!stored) { router.replace('/login/forgot'); return; }
    setPhone(stored);
  }, [router]);
  ...
  async function handleVerify(code: string) {
    ...
    try {
      ...
      sessionStorage.setItem('baari_reset_token', data.resetToken);
      router.push('/login/forgot/new-password');
    } catch {
